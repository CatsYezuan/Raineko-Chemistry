...
- 分享部分截取内容或者衍生创作
  > 目前本站全部原创文章的衍生品禁止公开分享和分发。如有修改建议或衍生创作需求，请通过仓库的 GitHub Issues 联系。
...
本着互联网开放精神，你可以通过仓库的 GitHub Issues 申请授权博文衍生品的分享和分发，并注明你的网站地址。

## 网站源代码协议

本站主题改造代码沿用仓库所附的 `MIT` 许可证；文章、图片及学习资料仍以各页面标注的内容许可为准。
